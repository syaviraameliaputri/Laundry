...
// mengambil harga laundry, harga per kilo dari database
$h = mysqli_query($koneksi, "select harga_per_kilo form harga");
...
mysqli_query($koneksi, "insert into transaksi values('', '$tgl_hari_ini', '$pelanggan', '$berat', '$tgl_selesai', '$status')");
